    ...
    <div className="min-h-screen bg-background pb-20 pt-16">
      <div className="container mx-auto px-6 py-8 max-w-4xl">
        ...
        <div className="text-center mb-8">
          <h1 className="font-playfair text-4xl font-bold mb-4 text-primary">Chat</h1>
          <p className="text-muted-foreground text-lg">
            Ask the assistant about faith, the Bible and Light Embassy Church, join thoughtful
            community discussions, and study Scripture — all in one place.
          </p>
        </div>
              ...
              <CardContent className="flex flex-col gap-3 p-6 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <h2 className="text-lg font-semibold text-foreground">
                    Featured guide: Godly Living and Purpose
                  </h2>
